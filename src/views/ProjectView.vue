<template>
  <BContainer>
    ...
    >
      <div class="mb-3">
        ...
        <BRow class="text-center mt-4">
          <ProjectList
            :projects="projects"
            @project-clicked="showProjectDetails"
    ...
    <!-- 프로젝트 상세 모달 -->
    <BModal v-model="isDetailModalVisible" hide-footer hide-header size="xl">
      <ProjectDetail
    ...
    <!-- 프로젝트 추가 모달 -->
    <BModal v-model="isModalVisible" hide-footer hide-header size="xl">
...
export default {
      ...
      projects: [
        {
          ...
          images: [
            {
              url: "https://i.namu.wiki/i/PJXhYEqwxDj8ck8vHS4zfbrur-ZxVdWSeKTuvAJnoDtLwky1YuZxN0DVu5DYCUwWfITmQGf0gB6km50-Yva3Cg.webp",
            },
            { url: "https://newsimg.sedaily.com/2022/05/13/265YCDPXAM_1.jpg" },
          ],
        },
        {
          id: uuidv4(),
        ...
        },
        {
          ...
          images: [
            {
              url: "https://image.newdaily.co.kr/site/data/img/2021/06/08/2021060800063_0.jpg",
            },
          ],
        },
        {
          ...
          images: [
            {
              url: "https://kr.aving.net/news/photo/202404/1789380_724854_1624.jpg",
            },
          ],
        },
        {
          ...
          images: [
            {
              url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSEVBGnE2rva5bDMpCoLVrM6c_y8U6nQttpSg&s",
            },
          ],
        },
        {
  ...
  methods: {
    ...
    updateProject(newProject) {
      ...
      const target = this.projects.find(
        (project) => newProject.id === project.id
      );
